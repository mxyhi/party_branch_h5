<template>
  <PageWrapper contentBackground contentClass="flex" dense contentFullHeight title="通知列表">
...
<script lang="ts" setup>
  ...
  import { deleteWorkNoticeApi, workNoticeListApi } from '/@/api/work/work';
    ...
    return [
      ...
      },
      {
        ...
        onClick: async () => {
          ...
          await deleteWorkNoticeApi(record.id);
          await reload();
        },
      },
    ];
