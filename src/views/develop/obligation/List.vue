  ...
  <PageWrapper contentBackground contentClass="flex" dense contentFullHeight title="活动列表">
    <BasicTable @register="registerTable">
      <template #toolbar>
        ...
        <a-button type="primary" @click="$router.push('/event/obligation/create')"> 添加 </a-button>
      </template>
...
<script lang="ts" setup>
  ...
  import { eventDeleteAPI, eventListApi } from '../../../api/work/obligation';
